#define CHAR_INDEX_DEG	127		// Does not match ascii value (176) so map manually.
const uint8_t font_8x16[][16] PROGMEM =
{
	...
	{0x30, 0x48, 0x84, 0x84, 0x84, 0x48, 0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}	// 127 '°'
};
...
#define FONT_FIRST_CHAR 2
#define FONT_NUM_CHARS 3
#define FIRST_CHAR_META 4

#define CHAR_ADDR_MSB 0
#define CHAR_ADDR_LSB 1
